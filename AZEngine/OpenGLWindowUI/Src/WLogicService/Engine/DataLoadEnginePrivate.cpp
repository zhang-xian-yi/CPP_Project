...
namespace ImguiRendererNS
{
	...
	{
		m_pIndexBufferS = new ImguiRendererNS::IndexBuffer();
		m_pVertexBufferS = new ImguiRendererNS::VertexBuffer();
		m_pVArray = new ImguiRendererNS::VertexArray();
		m_pVBufLayout = new ImguiRendererNS::VertexBufferLayout();
	}
